...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QPushButton, QLabel, QTextEdit, QVBoxLayout, QHBoxLayout, QFileDialog, QScrollArea, QSplitter
)
...
class App(QWidget):
    def __init__(self):
        ...
        self.latex_code = ''
        self.solution = ''
        self.latex_up_to_date = False  # Flag to track if LaTeX code is up-to-date
    ...
    def initUI(self):
        ...
        v_splitter.setSizes([50, 200, 200, 400, 100])
    ...
    def upload_image(self):
        ...
        if file_name:
            ...
            self.latex_up_to_date = False  # Image has changed
        else:
    ...
    def solve_equation(self):
        if not self.latex_up_to_date:
            result = self.convert_to_latex()
            if not result:
                return  # Conversion failed, stop processing

        if self.latex_code:
            try:
                # Encode the LaTeX code for the URL
                tex = urllib.parse.quote(self.latex_code)
